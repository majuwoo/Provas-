...
if Defeito > 0.10 or Dias > 5:
    print("\nPenalidade Alta: 20% de redução no lucro.")
    C_final = C_corrigido * 1.25
elif 0.05 <= Defeito <= 0.10 and Dias > 0:
    print("\nPenalidade Média: 10% de redução no lucro.")
    C_final = C_corrigido * 1.10
else:
    print("\nSem penalidade. Custo final apenas com correção.")
    C_final = C_corrigido

print(f"Custo Base Corrigido: R$ {C_corrigido:.2f}")
print(f"Custo Final do lote: R$ {C_final:.2f}")
